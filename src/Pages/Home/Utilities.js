            ...
            <Container className="align-content-center d-md-flex gap-3 flex-1 justify-content-evenly mx-auto mt-2 mb-5">
                <Card className="border-0 mb-3 mx-auto h-100" style={{width:250}}>
                    ...
                    <Card.Body className="text-justify pt-0">
                        <h5 className="card-title fw-bolder ">ALWAYS BY YOUR SIDE</h5>
                        <p className="card-text ">We take extensive measures to ensure all our products are made to the very highest standards and meet all relevant industry regulations.</p>
                ...
                <Card className="border-0 mb-3 mx-auto h-100" style={{width:250}}>
                    ...
                    <Card.Body className="text-justify pt-0">
                        <h5 className="card-title fw-bolder">FIND A LOCAL RETAILER</h5>
                        <p className="card-text ">LOTUS® products and accessories are available online and at retailers nationwide.</p>
                ...
                <Card className="border-0 mb-3 mx-auto h-100" style={{width:250}}>
                    ...
                    <Card.Body className="text-justify pt-0">
                        <h5 className="card-title fw-bolder">HOW CAN WE HELP?</h5>
                ...
                <Card className="border-0 mb-3 mx-auto h-100" style={{width:250}}>
                    ...
                    <Card.Body className="ext-justify pt-0">
